  ...
  return (
    <main className="flex flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
      ...
      >
        ...
        {/* Main Heading */}
        <h1 className="text-2xl sm:text-2xl md:text-5xl lg:text-6xl font-semibold tracking-wider my-6 lg:my-8 whitespace-nowrap">
          Full Stack Web Dev 🚀
          <br />
          Backend Dev & APIs
          <br />
        ...
        <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]">
          ...
          backends, I build complete digital solutions tailored for startups,
          agencies, and businesses looking to scale fast.
          <br />
          <br />
          With a strong focus on clean UI, RESTful API development,
          authentication, and performance optimization, I ensure your website or
